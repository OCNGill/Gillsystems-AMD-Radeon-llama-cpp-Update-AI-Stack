#!/usr/bin/env bash
# ============================================================
# Gillsystems Desktop Server Launcher (Linux / Dedicated RX 7600)
...
MODEL_PATH="${GILLSYSTEMS_DESKTOP_MODEL_PATH:-}"

if [[ -z "$MODEL_PATH" ]]; then
    for candidate in \
        "/home/<user>/Desktop/Models/$MODEL_FILENAME" \
        "/home/<user>/Desktop/Models/Working_Models/$MODEL_FILENAME" \
...
if [[ -z "$MODEL_PATH" ]]; then
    MODEL_PATH="/home/<user>/Desktop/Models/$MODEL_FILENAME"
fi
...
for candidate in \
    ...
    "/home/<user>/src/llama.cpp/bin/llama-server|/home/<user>/src/llama.cpp/build-hip/bin" \
    "/home/<user>/src/llama.cpp/build-hip/bin/llama-server|/home/<user>/src/llama.cpp/build-hip/bin"; do
...
echo "Starting Gillsystems Desktop LLM Server... (Dedicated HIP Core)"
...
if [[ ! -f "$MODEL_PATH" ]]; then
    ...
    echo "[Gillsystems] Set GILLSYSTEMS_DESKTOP_MODEL_PATH to override the detected model path."
    exit 1
fi
