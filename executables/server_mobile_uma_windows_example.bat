...
:: ============================================================
:: Gillsystems Mobile UMA Server Launcher (Windows / Tier 2)
...
set "MODEL_PATH=(C:\Users\<user>) Laptop\Desktop\Models\gemma-4-E4B.Q6_K.gguf"
set "HOST=192.0.2.93"
set "PORT=8012"
set "CTX_SIZE=49152"
set "GPU_LAYERS=99"
...
echo Starting Gillsystems Mobile UMA example server...
