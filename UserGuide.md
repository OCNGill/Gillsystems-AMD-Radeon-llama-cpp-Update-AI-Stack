...
```bat
executables/server_primary_hip_windows.bat
```
- Model: `gemma-4-31B.Q4_K_M.gguf`
- Model path resolution: prefers `C:\Models\Working_Models\gemma-4-31B.Q4_K_M.gguf`; override with `GILLSYSTEMS_PRIMARY_MODEL_PATH`
...
```bash
executables/server_deck_vulkan_linux.sh
```
- Context: 32 768 tokens
- Default output cap: 1 024 tokens
