...
| File | Change |
|------|--------|
| `executables/server_primary_hip_windows.bat` | Removed `JINJA_FILE` var, replaced `--chat-template-file` with `--chat-template gemma`, added `--repeat-penalty`/`--repeat-last-n` |
| `executables/server_desktop_rocm_linux.sh` | Fixed blank line in continuation, added `-b`/`-ub`, `--repeat-penalty`/`--repeat-last-n` |
| `executables/server_mobile_uma_windows.bat` | Added `--repeat-penalty`/`--repeat-last-n` |
| `executables/server_deck_vulkan_linux.sh` | Added `--repeat-penalty`/`--repeat-last-n` |
...
| Launcher | Result |
|----------|--------|
| `server_primary_hip_windows.bat --dry-run` | ✅ Launch command shows `--chat-template gemma`, `--repeat-penalty 1.15`, `--repeat-last-n 128` |
| `server_mobile_uma_windows.bat --dry-run` | ✅ Model path discovered, context 32768, all flags present |
| `server_desktop_rocm_linux.sh` bash syntax | ✅ No blank lines in continuation, all flags present |
| `server_deck_vulkan_linux.sh` bash syntax | ✅ Clean continuation, all flags present |
