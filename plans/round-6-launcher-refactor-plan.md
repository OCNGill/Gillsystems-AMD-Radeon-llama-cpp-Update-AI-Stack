...
|------|----|----|-----|------|-------|
| **Main Rig** | 192.0.2.10 | Windows 11 | RX 7900 XTX | 24 GB | gemma-4-31B.Q4_K_M.gguf |
| **HTPC** | 192.0.2.42 | Kubuntu | RX 7600 | 8 GB | gemma-4-E4B.Q6_K.gguf |
| **Laptop** | 192.0.2.93 | Windows 10 | Vega 6 (iGPU) | Shared 20 GB | gemma-4-E4B.Q6_K.gguf |
| **Steam Deck** | 192.0.2.139 | SteamOS | RDNA 2 APU | Shared 16 GB | gemma-4-E4B.Q6_K.gguf |
...
**File:** [`executables/server_primary_hip_windows.bat`](../executables/server_primary_hip_windows.bat:13)
...
**File:** [`executables/server_desktop_rocm_linux.sh`](../executables/server_desktop_rocm_linux.sh:167-170)
...
### File 1: [`executables/server_primary_hip_windows.bat`](../executables/server_primary_hip_windows.bat)
...
### File 2: [`executables/server_desktop_rocm_linux.sh`](../executables/server_desktop_rocm_linux.sh)
...
### File 3: [`executables/server_mobile_uma_windows.bat`](../executables/server_mobile_uma_windows.bat)
...
### File 4: [`executables/server_deck_vulkan_linux.sh`](../executables/server_deck_vulkan_linux.sh)
...
| 2 | Fix Main Rig bat | `executables/server_primary_hip_windows.bat` | Step 1 |
| 3 | Fix HTPC shell | `executables/server_desktop_rocm_linux.sh` | Step 1 |
| 4 | Fix Laptop bat | `executables/server_mobile_uma_windows.bat` | Step 1 |
| 5 | Fix Steam Deck shell | `executables/server_deck_vulkan_linux.sh` | Step 1 |
...
**Sequence:**
1. **Main Rig** (192.0.2.10): Pull first and verify the BAT starts correctly.
2. **HTPC** (192.0.2.42): Pull and verify the SH script.
3. **Laptop** (192.0.2.93): Pull and verify the BAT.
4. **Steam Deck** (192.0.2.139): Pull and verify the SH script.
