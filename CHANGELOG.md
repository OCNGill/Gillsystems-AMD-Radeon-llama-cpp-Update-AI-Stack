...
- **Dedicated Tier 2 server-only launchers**: Added `executables/server_mobile_uma_windows_example.bat` and `executables/server_deck_vulkan_linux_example.sh` for the Laptop and Steam Deck nodes without changing the shared root templates.
