...
```text
executables/server_primary_hip_windows.bat             # Windows 11, RX 7900 XTX, Gemma 4 31B
executables/server_desktop_rocm_linux.sh              # KUbuntu, RX 7600, Gemma 4 E4B
executables/server_mobile_uma_windows.bat  # Windows 10, Vega 6, Gemma 4 E4B
executables/server_deck_vulkan_linux.sh         # SteamOS, RDNA 2 APU, Gemma 4 E4B
```
...
|---|---|---|---|---|---|---|
| `executables/server_primary_hip_windows.bat` | primary-node | Windows 11 | Gemma 4 31B Q4_K_M | HIP/ROCm | 49 152 | 2 048 |
| `executables/server_desktop_rocm_linux.sh` | desktop-node | KUbuntu | Gemma 4 E4B Q6_K | ROCm/HIP | 32 768 | 1 536 |
| `executables/server_mobile_uma_windows.bat` | mobile-node | Windows 10 | Gemma 4 E4B Q6_K | Vulkan or HIP UMA | 32 768 | 1 024 |
| `executables/server_deck_vulkan_linux.sh` | deck-node | SteamOS | Gemma 4 E4B Q6_K | Vulkan | 32 768 | 1 024 |
| `executables/server_edit_per_node.bat` / `.sh` | Any | Both | edit me | edit me | edit me | edit me |
...
**Main notes:** The main launcher keeps the Dense 31B model as the highest-quality node, prefers the canonical `C:\Models\Working_Models\` root, accepts `GILLSYSTEMS_PRIMARY_MODEL_PATH` as an override, and resolves portable rocBLAS support files when present.
...
- [![Venmo](https://img.shields.io/badge/Venmo-Donate-3d95ce?logo=venmo&logoColor=white)](https://venmo.com/<donation-handle>) https://venmo.com/<donation-handle>
...
<p align="center">
	...
	<a href="https://venmo.com/<donation-handle>"><img src="Gillsystems_logo_stuff/Readme%20Donation%20files/venmo_icon.png" alt="Venmo" width="32" style="vertical-align:middle;"></a>
</p>
